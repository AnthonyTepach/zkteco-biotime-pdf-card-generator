          ...
          <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
            <div className="text-center">
              ...
              <h1 className="text-3xl text-gray-800 font-bold sm:text-5xl lg:text-6xl lg:leading-tight dark:text-gray-200">
                ...
                <span className="text-blue-500">reportes de fácil acceso</span>
              </h1>
            </div>
            ...
            <div
              className="hidden absolute top-2/4 left-0 transhtmlForm -translate-y-2/4 -translate-x-40 md:block lg:-translate-x-80"
              aria-hidden="true"
            >
              <svg
            ...
            <div
              className="hidden absolute top-2/4 right-0 transhtmlForm -translate-y-2/4 translate-x-40 md:block lg:translate-x-80"
              aria-hidden="true"
            >
              <svg
