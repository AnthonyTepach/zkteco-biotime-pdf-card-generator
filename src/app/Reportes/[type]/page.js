...
export default async function PerType({ params }) {
  const { type } = params;
  const punchs = await fetchPunchTime(type);
                      ...
                      <tr>
                        ...
                        <td className="h-px w-px whitespace-nowrap">
                          <div className="px-6 py-1.5">
                            ...
                            >
                              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg> 
                              Ver más
                            </a>
                          </div>
                        </td>
